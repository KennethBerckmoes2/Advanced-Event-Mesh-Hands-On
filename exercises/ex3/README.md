...
In this exercise, we will consume an event from our queue in SAP Integration Suite, advanced event mesh. For that we will use the Queue Consumer HTML/JS application and you will connect to the AEM broker.
...
1. As part of the Getting Started you have downloaded or cloned the basic samples from GitHub. Go to the folder that you downloaded or cloned.
...
5. Go to the line
        ...
        subscriber = new QueueConsumer('OrgName_FirstName_LastName');
        
and replace OrgName_FirstName_LastName with the name of your queue in Advanced Event Mesh.

![Pic 2](/./images/Exercise3_2.png)
...
12. Set "View by" to Protocol.

![View by Protocol](/./images/ViewByProtocol.png)

13. Expand Solace Web Messaging
