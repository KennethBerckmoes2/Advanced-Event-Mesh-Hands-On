...
After completing these steps you will have familiarized yourself with SAP Integration Suite, advanced event mesh.

1. Log into Advanced Event Mesh

Link: [https://eu10.console.pubsub.em.services.cloud.sap/login?zone-id=908a280d-c2f1-4d2b-b003-de94ffc5a4ee](https://eu20.console.pubsub.em.services.cloud.sap/login?tenant-id=a9e2668e-9a47-4982-9044-172bee54670d)

You should have received an email to set your password. In case you didn't receive an email or don't have access, please inform the instructors.
...
- Event Management: Event Portal provides event management services. This subscribed service provides powerful tools to create, design, share, and manage various aspects of an Event Driven Architecture (EDA) based on event brokers or other streaming technologies (such as Kafka). 
...
3. Click on Cluster Manager, this is where you can create and manage your brokers.

4. Create Service button.

![Pic 14](/./images/BrokerService1.png)

5. Enter a service name (**!!Choose a unique name for your broker e.g. MyBroker_FirstNameLastName!!**), select a Cloud Provider, Region, a Broker Release and Broker Version. Finally, a service type. To select the right service type, you need to know and understand the requirements of your client applications, for example:
...
![Pic 14](/./images/BrokerService2.png)

6. Choose the Create Service button and wait for the service to be created. This can take a couple of minutes.

7. Once, the broker is created, open the Broker Manager.
![Pic 14](/./images/ex2-14.png)  
8. Explore the Broker Manager
...
2. Click on the broker you created in the previous exercise
...
![Pic 5](/./images/ManageQueues.png)      
  
5. Click the +Queue button on the top right
  
![Pic 6](/./images/ex2-6.png)        
  
6. In the pop up enter the queue name: OrgName_FirstName_LastName (replace with the name of your organization and your firstname and lastname)
