...
Advanced Event Mesh supports a hierarchical topic structure, which mean you can be very descriptive in defining your topic. Use it to describe the contents or intent of your message payload data. There is no need to use flat, coarse-grained topic labels like other brokers. 
...
1. Go to the cluster manager, click on your broker and then on "Try Me!".
2. Now, copy the Client Username and Client Password to a notepad and click on "Open Broker Manager"

![Pic 2](/./images/TryMe.png)

3. In a next step connect both Publisher and Subscriber using the credentials from the previous page
...
![Pic 6](/./images/TryMeSend&Receive.png)
